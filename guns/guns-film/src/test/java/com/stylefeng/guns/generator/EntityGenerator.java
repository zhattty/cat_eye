...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("C:\\Users\\10625\\IdeaProjects\\cat_eye\\guns\\guns-film\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("ZhangYao");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/guns?characterEncoding=utf8&serverTimezone=PRC");
        ...
        strategy.setInclude(new String[]{"mtime_film_actor_t"});// 表名
//        "mtime_actor_t",
//                "mtime_banner_t",
//                "mtime_cat_dict_t",
//                "mtime_film_info_t",
